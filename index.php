...
//  $filmsArray = [
//      new Film ('Titolo film', 'Guglielmo de Cevoli', 137);
//      new Film ('Titolo film', 'Quenteen Tarantulino', 121);
//      new Film ('Titolo film', 'Silvester Bighorse', 117);
//      new Film ('Titolo film', 'Mariano Lombardo', 133);
//  ];
